...
class NVTDataTarget(models.Model):
    ...
    def button_sync_data(self):
        ...
        # Vamos assumir que seu modelo de destino tem um campo chamado 'external_id'
        # que corresponde ao 'origin_primary_key' no banco de dados de origem.
        for row_data in rows:
            
            row = dict(zip(headers, row_data))
            _logger.info('fila11 .. ' + str(row))
            # Aqui, você terá que mapear cada coluna para o campo correspondente no modelo Odoo.
            # A lógica exata dependerá de como 'field_ids' está estruturado.
            vals = {}
            ...
            # Busque o registro existente usando a chave primária
    ...
    def action_show_query_result(self):
        _logger.info('passssssssssssssssssssssssssssssssssssssssssss')
        self.ensure_one()
